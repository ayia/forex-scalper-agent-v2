...
from adaptive_thresholds import get_pair_profile, detect_session
...
if __name__ == "__main__":
    print("Adaptive Risk Manager - Test Mode")
    print("This module calculates dynamic position sizing and SL/TP")
    print("\nFeatures:")
    print("  - Session-based risk adjustment")
    print("  - Volatility-adaptive position sizing")
    print("  - Spread-aware risk management")
    print("  - Regime-specific SL/TP calculation")
