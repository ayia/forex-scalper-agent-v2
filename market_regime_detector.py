...
if __name__ == "__main__":
    ...
    print("This module detects market regimes for adaptive trading")
    print("\nRegime Types:")
    print("  - TRENDING_BULL: Strong uptrend")
    print("  - TRENDING_BEAR: Strong downtrend")
    print("  - RANGING: Sideways movement")
    print("  - VOLATILE: High volatility")
    print("  - CHOPPY: No clear direction")
    print("  - QUIET: Very low volatility")
